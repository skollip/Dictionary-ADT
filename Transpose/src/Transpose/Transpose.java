...
/**
 * This class uses the Transpose algorithm for searching.
 * 
 * @author Siddhartha
 *
 */
public class Transpose {
	...
	/**
	 * Runs the program by creating an instance of Transpose
	 * 
	 * @param args
	 */
	...
	public void printOutput(PrintStream output) {
		for(int i = 0; i < list.size(); i++) {
			output.println(list.lookAtItemN(i).getKey() + "    " + list.lookAtItemN(i).getValue());
		}
	}
}

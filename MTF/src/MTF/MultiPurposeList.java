...
/**
 * This class creates the custom linked list used for keeping track of key value
 * pairs.
 * 
 * @author Siddhartha
 *
...
public class MultiPurposeList<T> {
	...
	/**
	 * An internal class that creates the place holders for data in the linked
	 * list.
	 * 
	 * @author Siddhartha
	 *
	 ...
	 * 
	 * @param position
	 *            the index of where you want the object to be added
	 * @param data
	 *            that that will be added to the list
	 * @throws NullPointerException
	 *             if the parameter is null
	 * @throws IndexOutOfBoundsException
	 *             if the position is lower than 0 or larger than the size of
	 *             the list
	 */
	 ...
	 * 
	 * @param position
	 *            the location of the object of interest
	 ...
	 * 
	 * @param the
	 *            object being added to the rear of the list
	 * @throws NullPointerException
	 *             if the book parameter is null
	 */
	 ...
	 * 
	 * @param position
	 *            the location of the object that needs to be moved ahead
	 * @throws IndexOutOfBoundsException
	 *             if the position is lower than 0 or larger than the size of
	 *             the list
	 */
